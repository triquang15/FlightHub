...
INSERT INTO seed_pricing_fares VALUES
    ...
    (current_setting('flighthub_seed.flight_vn117', true)::bigint, current_setting('flighthub_seed.cabin_vn_a359_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vn', true)::bigint, 'Economy Basic', 'K', 36, 6.8, 2.4, 'Domestic basic', false, false, true, false, false, true, false, false, 'Economy Basic Conditions', false, NULL, NULL, true, 9, 24, 7, 1, 20, 1, false),
    (current_setting('flighthub_seed.flight_vn651', true)::bigint, current_setting('flighthub_seed.cabin_vn_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vn', true)::bigint, 'Economy Standard', 'M', 92, 14, 4, 'Regional standard', false, true, true, false, false, true, false, false, 'Economy Standard Conditions', true, 22, 3, true, 14, 24, 10, 1, 23, 1, false),
    (current_setting('flighthub_seed.flight_vn650', true)::bigint, current_setting('flighthub_seed.cabin_vn_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vn', true)::bigint, 'Economy Standard', 'M', 92, 14, 4, 'Regional standard', false, true, true, false, false, true, false, false, 'Economy Standard Conditions', true, 22, 3, true, 14, 24, 10, 1, 23, 1, false),
    (current_setting('flighthub_seed.flight_vn652', true)::bigint, current_setting('flighthub_seed.cabin_vn_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vn', true)::bigint, 'Economy Standard', 'M', 104, 15, 4, 'Regional standard', false, true, true, false, false, true, false, false, 'Economy Standard Conditions', true, 24, 3, true, 16, 24, 10, 1, 23, 1, false),
    (current_setting('flighthub_seed.flight_vj504', true)::bigint, current_setting('flighthub_seed.cabin_vj_a321_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vj', true)::bigint, 'Eco Saver', 'S', 25, 6, 2, 'Lowest fare', false, false, false, false, false, false, false, false, 'Eco Saver Conditions', false, NULL, NULL, true, 12, 24, 7, 1, 0, 0, false),
    (current_setting('flighthub_seed.flight_vj505', true)::bigint, current_setting('flighthub_seed.cabin_vj_a321_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_vj', true)::bigint, 'Eco Saver', 'S', 25, 6, 2, 'Lowest fare', false, false, false, false, false, false, false, false, 'Eco Saver Conditions', false, NULL, NULL, true, 12, 24, 7, 1, 0, 0, false),
    (current_setting('flighthub_seed.flight_ak512', true)::bigint, current_setting('flighthub_seed.cabin_ak_a320_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_ak', true)::bigint, 'Low Fare', 'L', 62, 9, 3, 'Low fare', false, false, false, false, false, false, false, false, 'Low Fare Conditions', false, NULL, NULL, true, 18, 24, 7, 1, 20, 1, false),
    (current_setting('flighthub_seed.flight_ak513', true)::bigint, current_setting('flighthub_seed.cabin_ak_a320_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_ak', true)::bigint, 'Low Fare', 'L', 62, 9, 3, 'Low fare', false, false, false, false, false, false, false, false, 'Low Fare Conditions', false, NULL, NULL, true, 18, 24, 7, 1, 20, 1, false),
    (current_setting('flighthub_seed.flight_sq176', true)::bigint, current_setting('flighthub_seed.cabin_sq_a359_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_sq', true)::bigint, 'Economy Value', 'V', 126, 18, 6, 'Value economy', false, true, true, false, true, true, true, false, 'Economy Value Conditions', true, 36, 5, true, 22, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_sq175', true)::bigint, current_setting('flighthub_seed.cabin_sq_a359_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_sq', true)::bigint, 'Economy Value', 'V', 126, 18, 6, 'Value economy', false, true, true, false, true, true, true, false, 'Economy Value Conditions', true, 36, 5, true, 22, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_tg560', true)::bigint, current_setting('flighthub_seed.cabin_tg_b77w_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_tg', true)::bigint, 'Economy Classic', 'W', 86, 13, 4, 'Classic economy', false, true, true, false, true, true, false, false, 'Economy Classic Conditions', true, 28, 4, true, 18, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_tg561', true)::bigint, current_setting('flighthub_seed.cabin_tg_b77w_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_tg', true)::bigint, 'Economy Classic', 'W', 86, 13, 4, 'Classic economy', false, true, true, false, true, true, false, false, 'Economy Classic Conditions', true, 28, 4, true, 18, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_cx743', true)::bigint, current_setting('flighthub_seed.cabin_cx_a35k_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_cx', true)::bigint, 'Economy Essential', 'E', 146, 19, 6, 'Essential economy', false, true, true, false, true, true, true, false, 'Economy Essential Conditions', true, 40, 5, true, 24, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_cx742', true)::bigint, current_setting('flighthub_seed.cabin_cx_a35k_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_cx', true)::bigint, 'Economy Essential', 'E', 146, 19, 6, 'Essential economy', false, true, true, false, true, true, true, false, 'Economy Essential Conditions', true, 40, 5, true, 24, 24, 10, 1, 25, 1, false),
    (current_setting('flighthub_seed.flight_ek393', true)::bigint, current_setting('flighthub_seed.cabin_ek_a388_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_ek', true)::bigint, 'Economy Saver', 'Q', 224, 34, 12, 'Long-haul saver', false, true, true, false, true, true, true, false, 'Economy Saver Conditions', true, 60, 7, true, 36, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_ek392', true)::bigint, current_setting('flighthub_seed.cabin_ek_a388_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_ek', true)::bigint, 'Economy Saver', 'Q', 224, 34, 12, 'Long-haul saver', false, true, true, false, true, true, true, false, 'Economy Saver Conditions', true, 60, 7, true, 36, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_qr971', true)::bigint, current_setting('flighthub_seed.cabin_qr_a359_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_qr', true)::bigint, 'Economy Classic', 'W', 218, 32, 10, 'Long-haul classic', false, true, true, false, true, true, true, false, 'Economy Classic Conditions', true, 58, 7, true, 34, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_qr970', true)::bigint, current_setting('flighthub_seed.cabin_qr_a359_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_qr', true)::bigint, 'Economy Classic', 'W', 218, 32, 10, 'Long-haul classic', false, true, true, false, true, true, true, false, 'Economy Classic Conditions', true, 58, 7, true, 34, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_jl752', true)::bigint, current_setting('flighthub_seed.cabin_jl_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_jl', true)::bigint, 'Economy Standard', 'M', 246, 36, 12, 'Japan standard', false, true, true, false, true, true, true, false, 'Economy Standard Conditions', true, 70, 7, true, 38, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_jl751', true)::bigint, current_setting('flighthub_seed.cabin_jl_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_jl', true)::bigint, 'Economy Standard', 'M', 246, 36, 12, 'Japan standard', false, true, true, false, true, true, true, false, 'Economy Standard Conditions', true, 70, 7, true, 38, 48, 10, 1, 30, 1, false),
    (current_setting('flighthub_seed.flight_jl753', true)::bigint, current_setting('flighthub_seed.cabin_jl_b789_eco', true)::bigint, 'ECONOMY', current_setting('flighthub_seed.airline_jl', true)::bigint, 'Economy Standard', 'M', 254, 38, 12, 'Japan standard', false, true, true, false, true, true, true, false, 'Economy Standard Conditions', true, 70, 7, true, 38, 48, 10, 1, 30, 1, false);
