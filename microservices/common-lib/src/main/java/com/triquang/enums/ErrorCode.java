...
public enum ErrorCode {
	...
	// CABIN CLASS
	// =========================
	CABIN_CLASS_NOT_FOUND("CAB_001", "CABIN_CLASS_NOT_FOUND", HttpStatus.NOT_FOUND),
	CABIN_CLASS_ALREADY_EXISTS("CAB_002", "CABIN_CLASS_ALREADY_EXISTS", HttpStatus.BAD_REQUEST),
	
	// =========================
	// SEAT MAP
	// =========================
	SEAT_MAP_NOT_FOUND("STM_001", "SEAT_MAP_NOT_FOUND", HttpStatus.NOT_FOUND),
	SEAT_MAP_ALREADY_EXISTS("STM_002", "SEAT_MAP_ALREADY_EXISTS", HttpStatus.BAD_REQUEST),
	SEAT_NOT_FOUND("STM_003", "SEAT_NOT_FOUND", HttpStatus.NOT_FOUND),
	SEAT_ALREADY_GENERATED("STM_004", "SEAT_ALREADY_GENERATED", HttpStatus.BAD_REQUEST),
	SEAT_MAP_EMPTY("STM_005", "SEAT_MAP_EMPTY", HttpStatus.BAD_REQUEST),
	...
	// PAYMENT
	// =========================
	PAYMENT_ALREADY_COMPLETED("PAY_001", "PAYMENT_ALREADY_COMPLETED", HttpStatus.BAD_REQUEST),
	UNSUPPORTED_PAYMENT_GATEWAY("PAY_002", "UNSUPPORTED_PAYMENT_GATEWAY", HttpStatus.BAD_REQUEST),
	PAYMENT_VERIFICATION_FAILED("PAY_003", "PAYMENT_VERIFICATION_FAILED", HttpStatus.BAD_REQUEST),
	PAYMENT_NOT_FOUND("PAY_004", "PAYMENT_NOT_FOUND", HttpStatus.NOT_FOUND),
