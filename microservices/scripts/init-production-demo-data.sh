...
FLIGHT_SEARCH_SEED_INSTANCE_LIMIT="${FLIGHT_SEARCH_SEED_INSTANCE_LIMIT:-90}"
...
echo "==> Resolving upcoming FlightInstance IDs for booking seat inventory (limit: $FLIGHT_SEARCH_SEED_INSTANCE_LIMIT per flight)"

flight_instances_vn210="$(lookup_upcoming_flight_instance_ids VN210 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn211="$(lookup_upcoming_flight_instance_ids VN211 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn218="$(lookup_upcoming_flight_instance_ids VN218 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn136="$(lookup_upcoming_flight_instance_ids VN136 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn117="$(lookup_upcoming_flight_instance_ids VN117 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn135="$(lookup_upcoming_flight_instance_ids VN135 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn651="$(lookup_upcoming_flight_instance_ids VN651 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn650="$(lookup_upcoming_flight_instance_ids VN650 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vn652="$(lookup_upcoming_flight_instance_ids VN652 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj122="$(lookup_upcoming_flight_instance_ids VJ122 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj123="$(lookup_upcoming_flight_instance_ids VJ123 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj504="$(lookup_upcoming_flight_instance_ids VJ504 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj505="$(lookup_upcoming_flight_instance_ids VJ505 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj803="$(lookup_upcoming_flight_instance_ids VJ803 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_vj804="$(lookup_upcoming_flight_instance_ids VJ804 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ak520="$(lookup_upcoming_flight_instance_ids AK520 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ak521="$(lookup_upcoming_flight_instance_ids AK521 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ak512="$(lookup_upcoming_flight_instance_ids AK512 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ak513="$(lookup_upcoming_flight_instance_ids AK513 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_sq185="$(lookup_upcoming_flight_instance_ids SQ185 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_sq186="$(lookup_upcoming_flight_instance_ids SQ186 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_sq176="$(lookup_upcoming_flight_instance_ids SQ176 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_sq175="$(lookup_upcoming_flight_instance_ids SQ175 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_tg551="$(lookup_upcoming_flight_instance_ids TG551 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_tg550="$(lookup_upcoming_flight_instance_ids TG550 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_tg560="$(lookup_upcoming_flight_instance_ids TG560 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_tg561="$(lookup_upcoming_flight_instance_ids TG561 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_cx764="$(lookup_upcoming_flight_instance_ids CX764 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_cx765="$(lookup_upcoming_flight_instance_ids CX765 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_cx743="$(lookup_upcoming_flight_instance_ids CX743 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_cx742="$(lookup_upcoming_flight_instance_ids CX742 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ek393="$(lookup_upcoming_flight_instance_ids EK393 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_ek392="$(lookup_upcoming_flight_instance_ids EK392 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_qr971="$(lookup_upcoming_flight_instance_ids QR971 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_qr970="$(lookup_upcoming_flight_instance_ids QR970 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_jl752="$(lookup_upcoming_flight_instance_ids JL752 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_jl751="$(lookup_upcoming_flight_instance_ids JL751 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
flight_instances_jl753="$(lookup_upcoming_flight_instance_ids JL753 "$FLIGHT_SEARCH_SEED_INSTANCE_LIMIT")"
