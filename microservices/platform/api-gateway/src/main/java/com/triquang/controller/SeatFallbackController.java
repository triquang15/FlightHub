...
public class SeatFallbackController extends BaseFallback {
    ...
    @RequestMapping("/api/**")
    @Operation(summary = "Seat service fallback", description = "Returns an empty fallback response when Seat Service is unreachable through the gateway circuit breaker.")
