...
export const SECTION_DESCRIPTIONS = {
  ...
  "operations-observability": "Open Grafana, Prometheus, Loki, Alertmanager, Elasticsearch, and Kibana from one tool hub",
  "operations-service-health": "Check gateway health, actuator metrics, and local service runtime endpoints",
  ...
  "configuration-integrations": "Review payment, notification, observability, webhook, and credential configuration",
  // Security
